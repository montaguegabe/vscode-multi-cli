...
LOCAL_GENERATED_SETTINGS_HEADER = "This file is generated by multi from settings.shared.json and/or settings.local.json. Do not edit directly."
...
class SettingsFileMerger(VSCodeFileMerger):
    ...
    def _post_process_json(self, merged_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        python_paths_to_add = [repo.relative_path for repo in repos if repo.is_python]
