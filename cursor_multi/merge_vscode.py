...
def clear_vscode_config_files():
    ...
    for file_to_delete in [
        paths.vscode_launch_path,
        paths.vscode_tasks_path,
        paths.vscode_settings_path,
    ]:
...
def merge_vscode_configs():
    ...
    write_json_file(paths.vscode_launch_path, merged_launch)

    # Merge tasks.json
    merged_tasks = merge_tasks_json(repos)
    write_json_file(paths.vscode_tasks_path, merged_tasks)
